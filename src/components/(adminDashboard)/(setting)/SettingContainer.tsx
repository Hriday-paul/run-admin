        ...
        if (link.path === "changePassword") {
          return (
            <div
              ...
              className="bg-[#824902]/10 p-5 rounded flex justify-between items-center cursor-pointer shadow"
            >
          ...
          return (
            <Link key={link.path} href={`/${link.path}`}>
              <div className="bg-[#824902]/10 p-5 rounded flex justify-between items-center shadow">
                <h4 className="text-text-color font-medium text-lg">
                  {link?.lable}
                </h4>
                <IoIosArrowForward size={18} color="#000000" />
